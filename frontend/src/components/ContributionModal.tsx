// This component is used for the Contribution Modal on the Project Detail Page, 
// which allows the user to contribute to the project by adding a photo, text, data, or correction.
